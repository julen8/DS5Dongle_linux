...
#ifndef DS5_DONGLE_LINUX_MAIN_H
#define DS5_DONGLE_LINUX_MAIN_H
...
class USBGadget {
public:
    explicit USBGadget(const std::string &name = "composite_gadget");
...
private:
    const std::vector<uint8_t> desc_hid_report = {
    ...
    static std::string find_udc();
};

#endif  // DS5_DONGLE_LINUX_MAIN_H
